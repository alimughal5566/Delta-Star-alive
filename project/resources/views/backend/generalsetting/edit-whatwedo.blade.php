...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{route('update.whatwedo')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group " >
                                            ...
                                            <img src="{{asset('assets/demos/construction/images/whatwedo/'.$data->thumbnail)}}" height="100px" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
